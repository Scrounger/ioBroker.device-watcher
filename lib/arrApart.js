...
const arrApart = {
	...
	"unifi-network": {
		Selektor: 'unifi-network.*.devices.*.state',
		timeSelector: '.uptime',
	...
	"unifi-protect-nvr": {
		Selektor: 'unifi-protect-nvr.*.isConnected',
		timeSelector: '.uptime',
		adapterID: 'unifi-protect-nvr',
		adapter: 'Unifi Protect NVR',
		battery: '.batteryStatus.isLow',
		reach: '.isConnected',
		isLowBat: '.batteryStatus.isLow',
		id: 'none',
		upgrade: '.fwUpdateState',
	},
	viessmann: {
